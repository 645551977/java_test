...
public class RPCMSD1185 extends BaseTest {


    @Test
    public void RPCMSD1185() throws Exception {
        try {
            ...
            Enter(By.id("workLogContext_textfield_isWorked")).sendKeys("1.5h");  //输入新的耗费时间

            clear(By.name("example-text"));  ////清空备注框

            Enter(By.name("example-text")).sendKeys("2222");  //输入新的备注
